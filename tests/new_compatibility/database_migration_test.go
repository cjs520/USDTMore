		...
		testOrders := []*model.TradeOrders{
			{
				...
				UsdtRate:  func() decimal.Decimal { d, _ := decimal.NewFromString("6.12345678"); return d }(), // numeric(18,8)
				Amount:    func() decimal.Decimal { d, _ := decimal.NewFromString("999999999.12345678"); return d }(), // 最大精度
				Money:     func() decimal.Decimal { d, _ := decimal.NewFromString("12345.99"); return d }(), // numeric(18,2)
				Chain:     "TRON",
			...
			},
			{
				...
				UsdtRate:  func() decimal.Decimal { d, _ := decimal.NewFromString("0.00000001"); return d }(), // 最小精度
				Amount:    func() decimal.Decimal { d, _ := decimal.NewFromString("0.00000001"); return d }(),
				Money:     func() decimal.Decimal { d, _ := decimal.NewFromString("0.01"); return d }(),
				Chain:     "BSC",
