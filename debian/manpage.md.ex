% usdtmore(SECTION) | User Commands
%
% "August 28 2024"
...
usdtmore - program to do something

# SYNOPSIS

**usdtmore** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**usdtmore** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **usdtmore** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**usdtmore** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    usdtmore. See **foo.conf**(5) for further details.
...
**usdtmore** provides some return codes, that can be used in scripts:
...
support <support@ovsea.net>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 support
